...
$yourLogo = "https://sequeldata.com/wp-content/uploads/2020/11/Sequel@2x.png"
$TableHeaderColour = "#00a1f1"
$applicationName = "Sequel Data Secure Score Exporter"
...
$homePage = "https://sequeldata.com"
$appIdURI = "https://sequeldata.com/$((New-Guid).ToString())"
